const PG = () => {
  return (
    <div className="flex w-full flex-col justify-center rounded-xl bg-[#111] bg-[url('https://res.cloudinary.com/ericboggs/image/upload/v1563324005/alchemy_bi6keb.jpg')] bg-cover bg-center px-4 shadow-lg md:flex-row">
      <div className="flex w-full flex-col items-center justify-center p-11 text-zinc-200 md:w-full">
        <h3 className="mb-0 pb-2 font-heading text-2xl font-bold uppercase">
          P&G
        </h3>
        <p className="mt-0 pb-2 text-center text-xl italic">
